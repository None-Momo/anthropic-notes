...
- The "secret weapon": Ask the AI itself to help improve your prompt.<br>
<span style="color:#E24B4A">**Use other AI models to write prompts**</span><br>
...
<div style="border-radius:18px; background:#d2cfe3; padding:28px; display:flex; gap:24px; align-items:center;">
	<div style="flex:0 0 140px; text-align:center;">
		<div style="width:120px; height:120px; margin:0 auto; border-radius:18px; background:#f5f3f7; display:flex; align-items:center; justify-content:center;">
			<span style="font-size:64px; line-height:1; color:#2d2a32;">✍️</span>
		</div>
	</div> 
	<div style="flex:1;">
		<h3 style="margin:0 0 10px 0; font-size:28px; color:#2d2a32;">
        6 techniques for effective prompt engineering</h3>
		...
		<a href="/anthropic-notes/public/ai-fluency/DD2_Handout__6_Effective_Prompting_Techniques.pdf" style="display:inline-block; padding:12px 22px; border-radius:12px; background:#6f6a80; color:#ffffff; text-decoration:none; font-weight:600;">Download</a>
	</div>
</div>